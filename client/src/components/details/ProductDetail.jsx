  ...
  return (
    <>
      ...
      <SmallText>
        ...
        <Typography><StyledBadge/>Sign up for GBN Pay Later and GBN Gift Card worth ₹100</Typography>
        <Typography><StyledBadge/>Buy 2 items save 5%; Buy 3 or more save 10% T&C</Typography>
        <Typography><StyledBadge/>5% Cashback on GBN Axis Bank Card</Typography>
